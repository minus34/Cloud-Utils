...
# *********************************************************************************************************************
# export_geojson_to_s3
# *********************************************************************************************************************
#
# A script for exporting a table from PostGIS to S# in an indexed folder structure
#
...
#  - Boto3 & Pyscopg2 Python modules installed
#
# Process:
#   1. run gnaf-loader as psma-admin-bdys to load and prep the PSMA Admin bdy data
#      OR load the data into PostGIS from GitHub: https://github.com/iag-geo/psma-admin-bdys
#   2. run this script
#
# *********************************************************************************************************************
